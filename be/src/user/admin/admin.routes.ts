...
import { sanitizeAdminInput, findAll, findOne, add, update, remove, getAccountInfo, searchAdminByText } from './admin.controller.js';
...
adminRouter.get('/search', verifyToken, verifyRole([UserRole.ADMIN]), searchAdminByText);
