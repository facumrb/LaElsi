...
photoRouter.post('/upload/productPhotos/:id', verifyToken, verifyRole([UserRole.ADMIN]), uploadProduct.array('files', 10), uploadProductPhotos);
...
photoRouter.post('/upload/userPhoto/:id', verifyToken, uploadProfile.single('file'), uploadUserPhoto);
